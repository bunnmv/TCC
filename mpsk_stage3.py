...
# Title: Mpsk Stage3
# Generated: Sun Feb 11 11:50:17 2018
##################################################
...
class mpsk_stage3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_pack_k_bits_bb_0_0_1, 0), (self.blocks_file_sink_0, 0))
        ...
        self.connect((self.fec_extended_decoder_0, 0), (self.blocks_pack_k_bits_bb_0_0_1, 0))
