...
# Title: Top Block
# Generated: Tue May 15 00:28:11 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.rx_inner_bpsk_0, 0), (self.rx_outer_convolutional_0, 0))
        ...
        self.connect((self.tx_outer_CE_0, 0), (self.tx_inner_bpsk_0, 0))
