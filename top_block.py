...
# Title: Top Block
# Generated: Mon Apr 23 14:08:00 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.digital_symbol_sync_xx_0_0 = digital.symbol_sync_cc(digital.TED_SIGNAL_TIMES_SLOPE_ML, sps, 6.82/100, 2*nfilts, 1.0, 1.5, 1, digital.constellation_8psk().base(), digital.IR_PFB_MF, nfilts, (rrc_taps))
    ...
    def set_nfilts(self, nfilts):
        self.nfilts = nfilts
        self.set_rrc_taps(firdes.root_raised_cosine(self.nfilts, self.nfilts*self.sps, 1.0, self.excess_bw, 45*self.nfilts))
        self.digital_symbol_sync_xx_0_0.set_damping_factor(2*self.nfilts)
