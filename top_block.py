...
# Title: Top Block
# Generated: Mon Mar 12 19:58:40 2018
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, frameLength=272, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.fec_extended_tagged_encoder_0 = fec.extended_tagged_encoder(encoder_obj_list=CE, puncpat='11', lentagname='len_key', mtu=frameLength)
        self.fec_extended_tagged_decoder_0 = self.fec_extended_tagged_decoder_0 = fec_extended_tagged_decoder_0 = fec.extended_tagged_decoder(decoder_obj_list=CD, ann=None, puncpat='11', integration_period=10000, lentagname='None', mtu=frameLength)
        ...
        self.blocks_tagged_stream_to_pdu_0 = blocks.tagged_stream_to_pdu(blocks.byte_t, 'len_key')
        ...
        self.connect((self.fec_extended_tagged_decoder_0, 0), (self.digital_correlate_access_code_xx_ts_1, 0))
        self.connect((self.fec_extended_tagged_encoder_0, 0), (self.blocks_tag_gate_0, 0))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--frameLength", dest="frameLength", type="intx", default=272,
        help="Set (22 + 11 *)2*4 [default=%default]")
    return parser
