...
# Title: Top Block
# Generated: Wed Oct 11 14:43:24 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rtlsdr_source_0.set_sample_rate(2.88e6)
        ...
        self.fec_extended_decoder_0 = fec.extended_decoder(decoder_obj_list=CC_D, threading= None, ann=None, puncpat='11', integration_period=10000)
        ...
        self.blocks_unpacked_to_packed_xx_0 = blocks.unpacked_to_packed_bb(int(np.log2(8)), gr.GR_MSB_FIRST)
        self.blocks_pack_k_bits_bb_0_0 = blocks.pack_k_bits_bb(8)
        self.blocks_char_to_float_0_0 = blocks.char_to_float(1, int(np.power(2,7)-1))
        self.blocks_char_to_float_0 = blocks.char_to_float(1, int(np.power(2,7)-1))
