...
class packet_tx_teste(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Packet Tx Teste")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Packet Tx Teste")
...
def main(top_block_cls=packet_tx_teste, options=None):
