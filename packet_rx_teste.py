...
class packet_rx_teste(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Packet Rx Teste")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Packet Rx Teste")
        ...
        self.settings = Qt.QSettings("GNU Radio", "packet_rx_teste")
...
def main(top_block_cls=packet_rx_teste, options=None):
