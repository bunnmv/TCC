...
# Generated: Thu May  3 12:54:30 2018
##################################################
...
class test_probe_mod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0)):
        ...
        self.fec_extended_tagged_encoder_0_0 = fec.extended_tagged_encoder(encoder_obj_list=CE, puncpat='11', lentagname='len_key', mtu=packetLength)
        ...
        self.connect((self.blks2_selector_0_0, 0), (self.fec_extended_tagged_encoder_0, 0))
        self.connect((self.blks2_selector_0_0, 1), (self.fec_extended_tagged_encoder_0_0, 0))
        self.connect((self.blks2_selector_0_0_0, 1), (self.blocks_null_sink_0, 0))
        self.connect((self.blks2_selector_0_0_0, 0), (self.blocks_repack_bits_bb_0_0_0_0_0_0, 0))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_null_source_0, 0), (self.blks2_selector_0_0, 1))
        self.connect((self.blocks_null_source_0_0, 0), (self.blks2_selector_0, 1))
        self.connect((self.blocks_repack_bits_bb_0_0_0_0, 0), (self.blks2_selector_0_0, 0))
        ...
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blks2_selector_0, 0))
        ...
        self.connect((self.fec_extended_tagged_encoder_0, 0), (self.blks2_selector_0_0_0, 0))
        self.connect((self.fec_extended_tagged_encoder_0_0, 0), (self.blks2_selector_0_0_0, 1))
    ...
    def set_PSK(self, PSK):
        self.PSK = PSK
        self._PSK_callback(self.PSK)
        self.blks2_selector_0.set_output_index(int(self.PSK))
    ...
    def set_FEC(self, FEC):
        self.FEC = FEC
        self._FEC_callback(self.FEC)
        self.blks2_selector_0_0_0.set_input_index(int(self.FEC))
        self.blks2_selector_0_0.set_output_index(int(self.FEC))
